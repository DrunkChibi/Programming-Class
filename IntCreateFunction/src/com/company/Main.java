...
Example
	...
	//Function Name: Mult
	//Inputs: 2 integers (num1 and num2)
	//What it should do: multiply num1 and num2
	//Returns: the integer that is result of multiply num1 and num2 together
	...
	public class Main {
		...
		public static void main(String[] args) {
			...
			System.out.println("start of Mult calls");
			int result = Mult(3,2);
...
*/////////////////////////////
    ...
    static void MyPrintFunction(){
        System.out.println("MyPrintFunction");
    }


    static void InMyPrintFunction() {
        System.out.println("InMyPrintFunction");
    }
    ...
    //What it should do: add num1 and num2
    //Returns: the integer that is result of adding num1 and num2 together
    static int Add(Integer First, Integer Sec) {
        int Sum = First + Sec;
        return Sum;
    }
